   ...
   <div id="lastfeed" class="w3-modal" style="z-index:100">
    <div class="w3-modal-content">
      ...
      <div class="w3-container">
        ...
        <p><?php echo "You last expressed {$dexpress['fluid']}ml ".gmdate('H:i', $timelastexpress)." ago at ".date('H:i', $dexpress['end_time']).". This took ".gmdate('H:i', $durationexpress); ?>. Don't forget that you only need to put a tick in the "Expressing" box and then record start, finish and amount to log expressed milk.</p>
